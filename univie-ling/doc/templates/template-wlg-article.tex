...
% Remove this and the \myblind... and \blind... macros for real documents
\usepackage{blindtext}
% Custom blindtext (Austrian not supported by blindtext package)
\newcommand*{\myblindtext}{\foreignlanguage{ngerman}{\blindtext}}
...
% dummy text (Austrian not supported by blindtext package)
\foreignlanguage{ngerman}{\blindlistlist[3]{itemize}}

% dummy text
\myblindtext

% dummy text (Austrian not supported by blindtext package)
\foreignlanguage{ngerman}{\blindlistlist[3]{enumerate}}
