...
% type=paper|review      Paper or Review article? (default: paper)
...
%
% Uncomment this for a tagged PDF
% Note: * this requires LaTeX 2025/06 at least!
...
%}
\documentclass[titlepage=specialprint,type=review]{univie-ling-wlg}
...
\title[Kurztitel für die Kopfzeile]{Titel des besprochenen Werks}
