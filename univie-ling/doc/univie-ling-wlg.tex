...
Also, if you give access dates to online documents, you can use the macro \jcsmacro{urldate\{<date>\}}, which will format the
date in the way preferred by the journal (``[last accessed: <date>]''), localized to English or German. The argument can be given
in the form YYYY-MM-DD, DD/MM/YYYY, or DD.MM.YYYY.
...
\raggedright
\begin{itemize}
  \item Forthcoming (v.\,2.6)
	\begin{itemize}
		\item Provide \jcsmacro{urldate} macro.
	\end{itemize}
