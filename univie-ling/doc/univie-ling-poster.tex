...
watch out for \emph{overfull vbox} warnings, but these are quite ambiguous.
...
In a second warning, the package provides you with its own evaluation on how to deal with the result.
Either of these three warnings will be given:
\begin{enumerate}
