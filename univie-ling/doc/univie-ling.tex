...
The classes and styles are particularly suited for the field of
Applied Linguistics and pre-load some packages that are considered useful in this disciplinary context. However, they might also be
(and actually are) used for General and Historical Linguistics as well as for other fields of study at Vienna University.
